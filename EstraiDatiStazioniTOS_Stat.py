...
w2 = open(out_sum, 'a+')
w2.write('cod; Stazione;  X_GB; Y_GB; start_day; end_day; tot_days; mis_days; norain_days; rain_days; cumul; max; min; media' + '\n')
...
for line1 in lis:
    try:
        ...
        if count_validvalue > 0:
            ...
            + ';' + my_max_str_comma + ';' + my_min_str_comma + ';' + my_aver_str_comma +';' +'\n')
